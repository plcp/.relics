// Not my work, taken from NFLlib (with few tweaks for testing purposes)
...
#include <gmp.h>
#include <mpfr.h>
// #include "fastrandombytes.h" // We will use a file as randomness source

#include <fstream>
void fastrandombytes(unsigned char *r, unsigned long long rlen)
{
    static std::ifstream ifs("randomness", std::ios::in | std::ios::binary);
    ifs.read((char*) r, rlen);
}
